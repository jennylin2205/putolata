            ...
            <Container>
                ...
                <Row>
                    ...
                    <Col>
                        ...
                        <p className="aboutus__des">Putolata là một website bán hàng, chuyên cung cấp những món ăn vặt hấp dẫn nhất 
                        trên thị trường với chất lượng tốt nhất và an toàn nhất.</p>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col md={4}>
                        ...
                        <p className="aboutus__des">Hiểu rõ đối tượng khách hạng của mình rất phong phú và đa dạng, chúng tôi hiểu rõ sứ mệnh và trách nhiệm của bản thân khi lập ra cửa hàng này. Chúng tôi cam kết với các bạn và 
                        chính bản thân mình về chất lượng của từng sản phẩm.</p>
                    </Col>
                    ...
                    <Col md={4}>
                        <p className="aboutus__subtitle">CAM KẾT</p>
                        <p className="aboutus__des">Chất lượng sản phẩm là một phần quan trọng trong mục tiêu tạo dựng chỗ đứng của thương hiệu Putolata trên thị trường.
                         Đó cũng là mục tiêu mà Putolata hướng đến</p>
                    </Col>
                </Row>
